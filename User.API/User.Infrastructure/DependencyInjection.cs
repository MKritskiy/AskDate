...
namespace Users.Infrastructure
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructureServices(this IServiceCollection services, IConfiguration config, ILogger logger)
        {
            ...
            services.AddSingleton<ICodeCacheService, RedisCodeCacheServicePlaceholder>();
            ...
            // });
            services.AddSingleton<INotificationQueueService, RabbitMqNotificationServicePlaceHolder>();
